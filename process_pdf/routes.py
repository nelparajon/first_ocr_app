...
def upload_file():
    if request.method == 'POST':
        ...
        try:
            ...
            process_file_1 = converter.convert_to_images(decoded_file_1)
            process_file_2 = converter.convert_to_images(decoded_file_2)
            logging.debug(f"Resultado de la conversión a imágenes: {process_file_1} - {process_file_2}")
            text_1 = producer.process_images(process_file_1)
            text_2 = producer.process_images(process_file_2)
